...
*** COMMENT Set moe and tsdh-light as standard themes.
...
#+END_SRC
*** COMMENT Set modus-operandi (light) and modus-vivendi (dark) as standard themes.
...
#+begin_src emacs-lisp
;; from https://cestlaz.github.io/post/using-emacs-75-bufler/
;; display buffer overview "full screen"
